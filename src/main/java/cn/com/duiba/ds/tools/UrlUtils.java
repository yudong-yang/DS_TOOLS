...
public class UrlUtils {
	...
	public UrlUtils(String appKey,String appSecret){
		this.appKey=appKey;
	 ...
	 * @return
	 */
	public String getQianzhiUrl(String count) {
	 ...
	 */
	public  String OrderList(String reqType, String rowId,
	 ...
	 * @return
	 */
	public  String activityData(String type, String count) {
		CreditTool tool = new CreditTool(appKey, appSecret);
		Map<String, String> params = new HashMap<String, String>();
	 ...
	 * @return
	 */
	public  String getPCDatalist(String vip, String uid, String limitNum) {
		CreditTool tool = new CreditTool(appKey, appSecret);
		Map<String, String> params = new HashMap<String, String>();
		params.put("vip", vip);
		params.put("uid", uid);
	 ...
	 * @return
	 */
	public  String getOrderStatusUrl(String orderNum, String bizId) {
		CreditTool tool = new CreditTool(appKey, appSecret);
		String url = tool.buildCreditOrderStatusRequest(orderNum, bizId);
		return url;
	}

	public  Map<String, String> UrltoMap(String Url, String appSecret)
			throws UnsupportedEncodingException {
		String getUrl = Url;
	 ...
	 * @return
	 */
	public  String batchCancel(String orderNums) {
	 ...
	 * @return
	 */
	public  String batchSend(String info) {
		CreditTool tool = new CreditTool(appKey, appSecret);
		Map<String, String> params = new HashMap<String, String>();
	 ...
	 * @return
	 */
	public  String batchAudit(String passOrderNums) {
		CreditTool tool = new CreditTool(appKey, appSecret);
		Map<String, String> params = new HashMap<String, String>();
	...
	public  String batchcancerAudit(String passOrderNums) {
		CreditTool tool = new CreditTool(appKey, appSecret);
		// CreditTool tool=new
	...
	public  String virtulconfirm(Boolean success, String errorMessage, String OrderNum){
		CreditTool tool = new CreditTool(appKey, appSecret);
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public  void signToolUrl(String appSecret,String URL) throws FileNotFoundException, IOException,
			UnsupportedEncodingException {
			Map<String, String> p =UrltoMap(URL, appSecret);
	...
	public  String getActivityTimes(String uid, String json ,String activityId, String times, String bizId) {
...
//		params.put("json", json);
	...
	public  String getActivityTimes2(String uid, String json ,String activityId, String times, String bizId) {
		CreditTool tool=new CreditTool("jlg88lyxz7siqtmr", "1x0eap95f4xfi77uaptrnwh9ewzvlm");
		//		CreditTool tool = new CreditTool(appKey, appSecret);
		Map<String, String> params = new HashMap<String, String>();
		params.put("uid", uid);
	...
	public  String getActivityTimes3(String uid, String json ,String activityId, String times, String bizId) {
		CreditTool tool=new CreditTool("jlg88lyxz7siqtmr", "1x0eap95f4xfi77uaptrnwh9ewzvlm");
		//		CreditTool tool = new CreditTool(appKey, appSecret);
		Map<String, String> params = new HashMap<String, String>();
		params.put("uid", uid);
