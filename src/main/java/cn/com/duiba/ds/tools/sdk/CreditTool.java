...
public class CreditTool {
	 ...
	 */
	public String buildUrlWithSignNew(String url,Map<String, String> params) throws NoSuchAlgorithmException, UnsupportedEncodingException{
		Map<String, String> newparams=new HashMap<String, String>(params);
		newparams.put("appKey", appKey);
		newparams.put("appSecret", appSecret);
		if(newparams.get("timestamp")==null){
		...
		String string="";
		string = string+newparams.get("timestamp")+newparams.get("appKey")+newparams.get("appSecret")+newparams.get("rowId");
